...
# https://dianying.taobao.com/cityAction.json?activityId&_ksTS=1723992367220_108&jsoncallback=jsonp109&action=cityAction&n_s=new&event_submit_doGetAllRegion=true
url = 'https://dianying.taobao.com/cityAction.json?activityId&_ksTS=1723992367220_108&jsoncallback=jsonp138&action=cityAction&n_s=new&event_submit_doGetAllRegion=true'
...
with open('爬虫12-urllib-解析jsonpath淘票票.json', 'w', encoding='utf-8') as f:
    f.write(content)

obj = json.load(open('爬虫12-urllib-解析jsonpath淘票票.json', 'r', encoding='utf-8'))
